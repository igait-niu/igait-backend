...
/**
 * @brief Login is used for our interaction with Firebase authentication,
 * this is safe on the frontend via oAuth3.0
 * 
 * @note This component contains functions for the following
 * - Creating via email
 * - Resetting passwords
 * - Google login
...
function Login() {        
    ...
    */
    ...
    return ( 
        <div className="Login">
            ...
            <div className='google-login'>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="google-logo" viewBox="0 0 16 16">
                    ...
                    <p>{loginMenuStatus ? 'LOGIN WITH GOOGLE' : 'LOG IN WITH GOOGLE'}</p>        
                </button>
            </div>
            ...
            <form className="email-container" onSubmit={handleLogin}>
        ...
        {/* Below is the UI for password reset */}
        {resetPasswordStatus && 
        <div className="background1">        
            <div className='reset-password-section'>
                ...
                {!invalidEmail &&  <div className="email-box">
                    ...
                    <span>EMAIL *</span>
                    <div className='login-button-menu-reset' onClick={handlePasswordReset}>
            ...
            {invalidEmail && <div style={{color: "white"}}className='reset-password-message'>
                <div className="error-message">
                    <p>An email has been sent to your registered email address. Please check your inbox (and your spam folder, just in case) and follow the instructions provided in the email to reset your password.</p>
                </div>
