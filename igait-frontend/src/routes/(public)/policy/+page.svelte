<script lang="ts">
	...
	import { FileText, Lock, Eye, Share2, UserCheck, Clock, Mail } from '@lucide/svelte';
</script>

<svelte:head>
	<title>Privacy Policy - iGait</title>
	<meta name="description" content="Learn about how iGait collects, uses, and protects your personal information." />
</svelte:head>
...
<div class="py-12">
	<div class="mx-auto max-w-4xl px-4">
		...
		<div class="text-center mb-12">
			...
			<h1 class="text-4xl font-bold tracking-tight">Notice of Privacy Policy</h1>
			...
			<Card.Header>
				<div class="flex items-center gap-3">
					...
					<div>
						...
						<Card.Description>How we collect, use, and protect your information</Card.Description>
					</div>
				</div>
			</Card.Header>
