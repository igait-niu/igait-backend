<script lang="ts">
	...
	import { ScrollText, Lock, Eye, Share2, UserCheck, Clock, Mail } from '@lucide/svelte';
</script>

<svelte:head>
	<title>Terms of Service - iGait</title>
	<meta name="description" content="Read the terms of service for using the iGait gait analysis platform." />
</svelte:head>
...
<div class="py-12">
	<div class="mx-auto max-w-4xl px-4">
		...
		<div class="text-center mb-12">
			<Badge variant="secondary" class="mb-4">Legal</Badge>
			<h1 class="text-4xl font-bold tracking-tight">Notice of Terms of Service</h1>
		...
		<Card.Root>
			<Card.Header>
				<div class="flex items-center gap-3">
					...
					<div>
						<Card.Title class="text-2xl">Terms of Service</Card.Title>
						<Card.Description>Terms governing your use of iGait services</Card.Description>
					</div>
				</div>
			</Card.Header>
